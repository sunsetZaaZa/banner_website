export default function WorkshopTools() {
    return (
        <>
            <div style={{marginLeft: '60px', paddingBottom: '10px'}}>Numerous functionality and features possible on a website are feasible on mobile apps</div>

            <div style={{marginLeft: '35px', fontWeight: "bold"}}>Flutter UI Design & Implementation with Android & iOS native libary support</div>
            <ul style={{marginTop: '0px', marginBottom: '30px'}}>
                ...
                <li>
                    Cross platform sqlite database for mobile, tablet and web browser. We can design, implement, test and upgrade queries and commands from the ground up. Resolving to CREATE, INSERT, SELECT, DELETE, ALTER and PRAGMA queries and commands to stand-up, configure and use the database
                    <br></br>
            ...
            <ul style={{marginTop: '0px', paddingBottom: '10px'}}>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            NodeJS , Deno 2 , BunJS with Express or Elysia to include JWT for user login and registration
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    Register and / or Login user using Keycloak as source of authenticating credentials to an account with a scope or mixture of. Account is backed by SQL or NoSQL or Realtime Cache or Third-party Service and interact with account information
                </li>
                <li>
                    Containerize software package for Docker and Kubernates
                </li>
                <li>
                    Interact with Stripe payment network
                </li>
            ...
            <ul style={{marginTop: '0px', paddingBottom: '10px'}}>
                <li>
                    ...
                    <ul>
                        <li>
                            React , Redux / Redux-Toolkit , React Router or NextJS
                        </li>
                        <li>
